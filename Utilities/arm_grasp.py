...
from bosdyn.client.robot_command import RobotCommandClient, blocking_stand, block_until_arm_arrives,RobotCommandBuilder
...
def arm_object_grasp(config):
    ...
    with bosdyn.client.lease.LeaseKeepAlive(lease_client, must_acquire=True, return_at_exit=True):
        ...
        pickUp(robot_state_client, command_client, robot)
...
def pickUp(robot_state_client, command_client, robot):
...
#Once Pick up is done start on Placing
#def Placing ():
    #pass
