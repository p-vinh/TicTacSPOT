...
def run_joint_control(config):
    ...
    # Streaming api clients does not work currently (2024)
    sdk.register_service_client(RobotCommandClient)
    sdk.register_service_client(RobotStateClient)
    ...
    with bosdyn.client.lease.LeaseKeepAlive(lease_client, must_acquire=True, return_at_exit=True):
        ...
        def handle_state_streaming():
            ...
            for state in robot_state_client.get_robot_state():
